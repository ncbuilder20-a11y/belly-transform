...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Transformation de la taille — Victoria Korshak" },
      { property: "og:description", content: "Programme de 14 jours · 5 minutes par jour · Méthode douce de réhabilitation viscérale." },
