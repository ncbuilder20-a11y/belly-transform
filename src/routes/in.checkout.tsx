...
function CheckoutPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // Let the native GET form submit do the navigation — it's the most reliable path.
    // We just fire the telegram beacon synchronously before the browser navigates.
    setError(null);
    setSubmitting(true);
    ...
    notifyLead(value);
    // Do NOT preventDefault — native form GET submission carries the user to PAY_URL.
  };
      ...
      <section className="flex-1 flex items-start sm:items-center justify-center px-5 py-10 md:py-16">
        <div className="w-full max-w-md bg-white shadow-sm border" style={{ borderColor: "rgba(193,122,90,0.15)" }}>
          <div className="p-6 sm:p-8">
            ...
            {/* Pure native GET form → 100% reliable on any device / any browser / JS-disabled. */}
            <form
