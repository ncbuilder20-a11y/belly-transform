    ...
    <section className="py-20 md:py-28" style={{ background: "var(--color-surface)" }}>
      <div className="mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          ...
          <div className="mt-10">
            <CTA>Get the bonuses + program — ₹249</CTA>
          </div>
        </Reveal>
      </div>
    </section>
          ...
          <div className="mt-12 flex flex-col items-center gap-8">
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-baseline gap-3 mt-1">
                <span className="font-display text-6xl font-semibold" style={{ color: "var(--color-terra)" }}>₹249</span>
                <span className="text-lg line-through text-white/50">₹2499</span>
              </div>
            </div>
            <CTA>Enrol now</CTA>
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-3">
        <div className="flex items-baseline gap-2 min-w-0">
          <span className="font-display text-xl md:text-2xl" style={{ color: "var(--color-terra)" }}>₹249</span>
...
function BuyModal() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    window.location.href = `${PAY_URL}&id=${encodeURIComponent(value)}`;
  };
